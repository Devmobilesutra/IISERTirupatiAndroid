package com.mobilesutra.iiser_tirupati.view;
...
/**
 * Created by kalyani on 05/05/2016.
 */
public class RadioButtonTabLayout extends TableLayout implements
    ...
    public RadioButtonTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
