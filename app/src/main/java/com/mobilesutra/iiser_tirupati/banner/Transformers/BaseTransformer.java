 ...
 *
 * BaseTransformer implement {@link com.mobilesutra.iiser_tirupati.banner.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.mobilesutra.iiser_tirupati.banner.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.mobilesutra.iiser_tirupati.banner.Animations.BaseAnimationInterface}
 * work.
 *
