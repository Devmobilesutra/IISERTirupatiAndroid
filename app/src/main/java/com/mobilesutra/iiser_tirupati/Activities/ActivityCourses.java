...
import com.mobilesutra.iiser_tirupati.Fragment.Fragment_BSMS_Course;
import com.mobilesutra.iiser_tirupati.Fragment.Fragment_IntegratedPhD_course;
import com.mobilesutra.iiser_tirupati.Fragment.Fragment_PhD_Course;
 ...
 */
public class ActivityCourses extends AppCompatActivity implements BaseSliderView.OnSliderClickListener,
    ...
    String LOG_TAG ="ActivityCourses ";
...
*/
                    ...
                    public void onPageSelected(int position) {
                       ...
                       /* Log.d("Fragment", "onPageSelected->" + position);
                        Fragment fragmentDemo =
                                getSupportFragmentManager().findFragmentById(R.id.viewpager);select * from tbl_course ;
    ...
    static class PagerItem {
        ...
        android.support.v4.app.Fragment createFragment() {
            IISERApp.log("Fragment", "In createFragment");
            if (mTitle.toString().equalsIgnoreCase("BS-MS Programme"))
                return Fragment_BSMS_Course.newInstance(mTitle.toString());
            else if (mTitle.toString().equalsIgnoreCase("Integrated PhD Programme"))
                return Fragment_IntegratedPhD_course.newInstance(mTitle.toString());
            else if (mTitle.toString().equalsIgnoreCase("PhD Program"))
                return Fragment_PhD_Course.newInstance(mTitle.toString());
            else
                return null;
        }
