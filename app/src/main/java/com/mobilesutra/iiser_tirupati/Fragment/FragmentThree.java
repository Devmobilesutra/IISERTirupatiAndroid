...
import com.mobilesutra.iiser_tirupati.Activities.ActivityCourseDetails;
...
public class FragmentThree extends Fragment implements BaseSliderView.OnSliderClickListener,
...
*/
    ...
    /*private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Fragment_BSMS_Course(), "ONE");
        adapter.addFrag(new Fragment_IntegratedPhD_course(), "TWO");
        adapter.addFrag(new Fragment_Notice(), "Notice");
